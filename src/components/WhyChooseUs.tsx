...
export default function WhyChooseUs() {
  return (
    <section id="why-us" className="py-20 sm:py-24 bg-neutral-900/60 border-y border-neutral-800 relative">
          ...
          {GYM_DETAILS.highlights.map((item) => {
            ...
            return (
              <div
                ...
                className="p-6 sm:p-7 rounded-2xl bg-neutral-950 border border-neutral-800/80 hover:border-rose-500/40 transition-all duration-300 group flex flex-col justify-between"
              >
                <div>
                  <div className="w-12 h-12 rounded-xl bg-neutral-900 border border-neutral-800 flex items-center justify-center text-rose-500 group-hover:bg-rose-600 group-hover:text-white transition-colors mb-5">
                    <Icon className="w-6 h-6" />
                  </div>
                  <h3 className="font-display text-xl sm:text-2xl font-semibold uppercase text-white mb-2.5">
                    {item.title}
                  </h3>
