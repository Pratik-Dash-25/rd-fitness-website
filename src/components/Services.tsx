...
import { Check, Dumbbell, Flame, Apple, Activity, Users, Award } from 'lucide-react';
...
export default function Services() {
  return (
    <section id="services" className="py-10 sm:py-20 lg:py-28 bg-neutral-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 sm:mb-16 gap-4 sm:gap-6">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-neutral-900 hover:bg-neutral-800 text-white font-semibold text-xs sm:text-sm border border-neutral-800 hover:border-neutral-700 transition-all shrink-0"
          >
            ...
            return (
              ...
              >
                ...
                <div className="relative h-40 sm:h-52 w-full overflow-hidden">
                  ...
                  <div className="absolute bottom-3 left-3 sm:bottom-4 sm:left-4 p-2 sm:p-2.5 rounded-xl bg-neutral-900/90 backdrop-blur-md border border-neutral-700 text-rose-500 shadow-lg">
                ...
                <div className="p-4 sm:p-6 flex-1 flex flex-col justify-between">
                  <div>
                    <h3 className="font-display text-lg sm:text-2xl font-bold uppercase text-white mb-2 sm:mb-3 group-hover:text-rose-400 transition-colors">
                      {service.title}
                    </h3>
                    ...
                    <div className="space-y-2 sm:space-y-2.5 mb-4 sm:mb-6 pt-3 sm:pt-4 border-t border-neutral-800/60">
